...
/*!
 * The number of codec specific octets in the capability (including the codec type, mandatory/optional/proprietary for a2dp)
 */
typedef enum
{
    length_of_sbc_parameters = 6,
    length_of_mp3_parameters = 6,
    length_of_aac_parameters = 8,
    length_of_faststream_parameters = 10,
    length_of_aptx_parameters = 9,
    length_of_aptx_ll_parameters = 19,
    length_of_aptx_hd_parameters = 13,
    length_of_aptx_adaptive_parameters = 13,
    length_of_sbc_tws_parameters = 16,
    length_of_mp3_tws_parameters = 16,
    length_of_aac_tws_parameters = 18,
    length_of_aptx_tws_parameters = 19
} length_of_codec_specific_parameters_t;
...
const uint8 faststream_caps_sink[14] =
{
    ...
    0,
    AVDTP_SERVICE_MEDIA_CODEC,
    length_of_faststream_parameters,
    AVDTP_MEDIA_TYPE_AUDIO<<2,
...
/*! @name Default aptX Adaptive Capabilities
    Default capabilities that an application can pass to the A2DP library during initialisation.
*/
const uint8 aptx_ad_caps_sink[23] =
{
    AVDTP_SERVICE_MEDIA_TRANSPORT,
    0,
    AVDTP_SERVICE_MEDIA_CODEC,
    length_of_aptx_adaptive_parameters,
    AVDTP_MEDIA_TYPE_AUDIO<<2,
    AVDTP_MEDIA_CODEC_NONA2DP,
    ...
    APTX_SAMPLING_FREQ_48000 | APTX_SAMPLING_FREQ_44100 | APTX_CHANNEL_MODE_STEREO,
