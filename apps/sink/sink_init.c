...
{
    AudioPluginInitMicBiasDrive(sinkAudioGetMic1aParams());
    AudioPluginInitMicBiasDrive(sinkAudioGetMic1bParams());
    AudioPluginInitMicBiasDrive(sinkAudioGetMic2aParams());
    AudioPluginInitMicBiasDrive(sinkAudioGetMic2bParams());
    AudioPluginInitMicBiasDrive(sinkAudioGetMic3aParams());
    AudioPluginInitMicBiasDrive(sinkAudioGetMic3bParams());
}
