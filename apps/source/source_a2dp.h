...
/* QTI company defines */
#define A2DP_QTI_VENDOR_ID0           0xD7   /* QTI company ID 215 */
#define A2DP_QTI_VENDOR_ID1           0x00
#define A2DP_QTI_VENDOR_ID2           0x00
#define A2DP_QTI_VENDOR_ID3           0x00
...
#define A2DP_SBC_BLOCK_LENGTH_INDEX   7
...
#define A2DP_APTXHD_CODEC_ID0               0x24
#define A2DP_APTXHD_CODEC_ID1                0x0
...
#define A2DP_APTXHD_RESERVED                0x0


#ifdef INCLUDE_DUALSTREAM
#define A2DP_DUALSTREAM_ENABLED         (connection_mgr_get_enable_dual_stream_feature())
#define A2DP_DUALSTREAM_CONNECT_NEXT    (connection_mgr_get_connect_both_devices_enable_feature())
...
#define A2DP_SUPPORTED_FEATURES_WORD1_5SLOT                  0x0002
#define A2DP_SUPPORTED_FEATURES_WORD2_EDR_ACL_2MBPS_3MBPS    0x0600
#define A2DP_SUPPORTED_FEATURES_WORD3_EDR_ACL_3SLOT_5SLOT    0x0180

#define A2DP_MAX_ENDPOINTS              5

/* Note: PS_A2DP_PROFILE_DISABLED is assigned by MS_LYNC_ONLY_BUILD */
#define A2DP_ENABLED_INSTANCES          ((a2dp_get_profile_value() != A2DP_PROFILE_DISABLED) ? (A2DP_DUALSTREAM_ENABLED ? 2 : 1) : 0)
...
#define a2dp_seid_is_aptxhd(seid)       (seid == A2DP_SEID_APTXHD)
#define a2dp_seid_is_aptxll(seid)       (seid == A2DP_SEID_APTX_LOW_LATENCY)
...
{
    DEFAULT_CHOICE = 255,
    USE_AS_FIRST_CHOICE = 0,
    USE_AS_SECOND_CHOICE,
    USE_AS_THIRD_CHOICE,
    USE_AS_FOURTH_CHOICE,
    USE_AS_FIFTH_CHOICE
}A2DP_CHOICE_PREFERENCE_T;

/* A2DP profiles supported */
typedef enum
{
    A2DP_PROFILE_DISABLED,
    A2DP_PROFILE_1_2
} A2DP_PROFILE_T;
...
/****************************************************************************
NAME    
    a2dp_set_aptxhd_config

DESCRIPTION
    Sets the aptX-HD Stream-End Point configuration.
    If use_defaults is TRUE then the Stream-End Point will be set to the default configuration.
    If use_defaults is FALSE then the Stream-End Point will be set to the user defined configuration.
...
/****************************************************************************
NAME    
    a2dp_get_aptxhd_caps_size

DESCRIPTION
    Gets the size of the aptX-HD Stream-End Point configuration parameters.
...
#else
#define a2dp_configure_sbc() (FALSE)
#endif
...
#else
#define a2dp_configure_faststream() (FALSE)
#endif
...
#else
#define a2dp_configure_aptx() (FALSE)
#endif
...
#else
#define a2dp_configure_aptxLowLatency() (FALSE)
#endif

/****************************************************************************
NAME    
    a2dp_configure_aptxhd

DESCRIPTION
    Configures the aptX-HD codec during the Media Open procedure.

RETURNS
    TRUE if the aptX-HD codec has been configured.
    FALSE if the aptX-HD codec could not be configured.
*/
#ifdef INCLUDE_APPLICATION_A2DP_CODEC_CONFIGURATION
bool a2dp_configure_aptxhd(A2DP_CODEC_CONFIGURE_IND_T *message);
#else
#define a2dp_configure_aptxhd() (FALSE)
#endif
...
DESCRIPTION
    Helper function to set the memory for codec config
...
DESCRIPTION
    Helper function to get the memory for codec config.
...
RETURNS
    The value as configured in the module xml file of  A2DP.
