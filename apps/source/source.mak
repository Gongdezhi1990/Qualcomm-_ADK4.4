...
## Include aptX HD encoder - uncomment the following lines when enabling aptX HD
#image/aptxhd_encoder/aptxhd_encoder.kap : 
#	$(mkdir) image/aptxhd_encoder
#	$(copyfile) ../../kalimba/apps/a2dp_source/image/aptxhd_encoder/aptxhd_encoder.kap $@

#image.fs : image/aptxhd_encoder/aptxhd_encoder.kap