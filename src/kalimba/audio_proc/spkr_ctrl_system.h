...
#define SPKR_CTRL_SYSTEM_HEADER_INCLUDED
    ...
    .const   $spkr_ctrl_system.CACHE_PRIM_EQ_PROC_FUNC      12; 
    .const   $spkr_ctrl_system.CACHE_SEC_EQ_PROC_FUNC       13; 
    .const   $spkr_ctrl_system.CACHE_BASS_EQ_PROC_FUNC      14; 
    .const   $spkr_ctrl_system.STRUCT_SIZE                  15; 
