...
/****************************************************************************
DESCRIPTION: CsrInitialiseI2SDevice_CSRA6620 :
...
RETURNS:
    none
*/    
void CsrInitialiseI2SDevice_CSRA6620(uint32 sample_rate)
{
	config_step_index = 0;
...
void handleNextConfigStep(void)
{
    ...
    switch(config_step_index)
    {
        ...
        case 7:        
        {
            ...
            CsrSetVolumeI2SDevice_CSRA6620(DEFAULT_LEFT_VOLUME_DB, 
...
RETURNS:
    none
*/    
void CsrSetVolumeI2SDevice_CSRA6620(int16 left_vol, int16 right_vol, bool volume_in_dB)
{   
...
/****************************************************************************
DESCRIPTION: CsrShutdownI2SDevice_CSRA6620 :
...
RETURNS:
    none
*/    
void CsrShutdownI2SDevice_CSRA6620(void)
{   
