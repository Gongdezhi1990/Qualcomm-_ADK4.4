...
void CsrA2dpDecoderPluginDisconnectMic(A2dpPluginConnectParams *codecData)
{
    ...
    if (l_src)
    {
        ...
        AudioPluginSetMicBiasDrive(codecData->mic_params->mic_a, FALSE);
    }
    ...
    if(DECODER->features.use_two_mic_back_channel)
    {
        ...
        if(r_src)
        {
            ...
            AudioPluginSetMicBiasDrive(codecData->mic_params->mic_b, FALSE);
        }
    }
}
...
void CsrA2dpDecoderConnectBackChannel(A2dpPluginConnectParams * codecData, bool use_two_mic_back_channel)
{
    ...
    /* Set mic bias drive */
    AudioPluginSetMicBiasDrive(codecData->mic_params->mic_a, TRUE);
    ...
    if(use_two_mic_back_channel)
    {
        ...
        /* set mic b bias drive */
        AudioPluginSetMicBiasDrive(codecData->mic_params->mic_b, TRUE);
