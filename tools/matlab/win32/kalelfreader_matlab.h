...
typedef struct { char const *name; uint32 size_in_addressable_units; uint32 addr; uint32 type_id; char const *source_file; int line_number; } KerVariable, *KerVariablePtr;
