...
class Ker:
    ...
    def _declare_cfuncs(self):
        ...
        gen_prototype('ker_open_file_req_extra_sections',  [c_char_p, POINTER(c_char_p), c_uint, POINTER(c_void_p)], POINTER(KerError))
        ...
        gen_prototype('ker_get_pm_data',    [c_void_p, POINTER(c_int), POINTER(POINTER(KerData))],
                      POINTER(KerError))
        gen_prototype('ker_get_extra_named_non_allocable_section_data', [c_void_p, c_char_p, POINTER(POINTER(KerData))],
                      POINTER(KerError))
    ...
    def open_file(self, path, extra_non_allocable_named_sections = ()):
        ...
        try:
            if extra_non_allocable_named_sections:
                ...
                sect_names = (c_char_p * num_sections)(*extra_non_allocable_named_sections)
