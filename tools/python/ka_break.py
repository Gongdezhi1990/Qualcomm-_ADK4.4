...
class KaBreak:
    ...
    def __init__(self, core):
        ...
        self._core._add_cfunc(self._cfuncs, 'ka_clear_all_pm_breaks', POINTER(ka_err), [c_void_p])
        self._core._add_cfunc(self._cfuncs, 'ka_clear_all_dm_breaks', POINTER(ka_err), [c_void_p])
