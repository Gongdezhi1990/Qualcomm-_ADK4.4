...
class KaArch:
    ...
    def __init__(self, core):
        ...
        self._core._add_cfunc(self._cfuncs, 'ka_hal_is_hydra'         , c_byte  , [c_void_p])
        self._core._add_cfunc(self._cfuncs, 'ka_hal_is_bluecore'      , c_byte  , [c_void_p])
        self._core._add_cfunc(self._cfuncs, 'ka_hal_is_always_enabled', c_byte  , [c_void_p])
        self._core._add_cfunc(self._cfuncs, 'ka_get_subsystem_id'     , c_int   , [c_void_p])
        self._core._add_cfunc(self._cfuncs, 'ka_supports_minim'       , c_byte  , [c_void_p])
    ...
    def get_chip_name(self):
        ...
        """
        return self._cfuncs['ka_get_chip_name'](self._lib())
