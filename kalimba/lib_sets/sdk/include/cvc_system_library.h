...
.CONST $M.CVC.VMMSG.STATUS_REQUEST  0x1017;
.CONST $M.CVC.VMMSG.STATUS_RESPONSE 0x1018;
...
.CONST $M.CVC.STATUS.SYSID                      0;
.CONST $M.CVC.STATUS.CPU_MHZ                    1;
.CONST $M.CVC.STATUS.TOTAL_MIPS                 2;
.CONST $M.CVC.STATUS.COUNT                      3;
