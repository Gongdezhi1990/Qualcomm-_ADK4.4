...
#ifndef CBOPS_CONDITIONAL_HEADER_INCLUDED
#define CBOPS_CONDITIONAL_HEADER_INCLUDED
   ...
   // Conditional Operator parameters appended

#endif // CBOPS_CONDITIONAL_HEADER_INCLUDED
