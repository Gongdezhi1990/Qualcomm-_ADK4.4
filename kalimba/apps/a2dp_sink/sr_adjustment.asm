...
wired_fix:
   ...
   r0 = M[r0];
#ifdef SRA_IMPROVED_LATENCY_FILTER
   // moving average: average = average * (1 - 2^-SRA_LATENCY_AVERAGE_FACTOR) + new_value * 2^-SRA_LATENCY_AVERAGE_FACTOR
   r1 = M[$sra_struct + $sra.AVERAGE_LATENCY_FIELD];
   r2 = r1 ASHIFT -SRA_LATENCY_AVERAGE_FACTOR;
   r1 = r1 - r2;
   r2 = r0 ASHIFT -SRA_LATENCY_AVERAGE_FACTOR;
   r1 = r1 + r2;
   M[$sra_struct + $sra.AVERAGE_LATENCY_FIELD] = r1;
#else //SRA_IMPROVED_LATENCY_FILTER
   // us -> 0.1ms
   r0 = r0 * 0.01 (frac);
   // accumulate latency values
   r0 = r0 + M[$sra_struct + $sra.LATENCY_ACC_FIELD];
   M[$sra_struct + $sra.LATENCY_ACC_FIELD] = r0;
#endif //SRA_IMPROVED_LATENCY_FILTER
...
#if defined(SRA_TARGET_LATENCY) && !defined(SRA_IMPROVED_LATENCY_FILTER)
...
#ifndef SRA_IMPROVED_LATENCY_FILTER
...
// -- idle mode function
 idle:
   ...
   if POS jump start;
#ifdef SRA_IMPROVED_LATENCY_FILTER   
   // Seed the latency average with the current latency value
   r0 = M[$sra_struct + $sra.CURRENT_LATENCY_PTR_FIELD];
   r0 = M[r0];
   M[$sra_struct + $sra.AVERAGE_LATENCY_FIELD] = r0;
#endif //SRA_IMPROVED_LATENCY_FILTER   
