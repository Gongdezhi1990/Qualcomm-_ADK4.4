...
#define LATENCY_AVERAGE_FACTOR                             11
...
init:
   ...
   r0 = r0 * 1000 (int);
   M[$M.configure_latency_reporting.average_latency] = r0;
...
$report_latency_to_vm:
   ...
   r3 = M[$M.configure_latency_reporting.average_latency];
...
calculate_average_latency:
   ...
   r0 = &$encoded_latency_struct;
   r0 = M[r0 + $encoded_latency.TOTAL_LATENCY_US_FIELD];
   // moving average: average = average * (1 - 2^-LATENCY_AVERAGE_FACTOR) + new_value * 2^-LATENCY_AVERAGE_FACTOR
   r1 = M[$M.configure_latency_reporting.average_latency];
   r2 = r1 ASHIFT -LATENCY_AVERAGE_FACTOR;
   r1 = r1 - r2;
   r2 = r0 ASHIFT -LATENCY_AVERAGE_FACTOR;
   r1 = r1 + r2;
   M[$M.configure_latency_reporting.average_latency] = r1;
...
func:
   ...
   Null = r4 - M[$target_latency_from_vm];
   if Z jump target_latency_not_updated;
   M[$target_latency_from_vm] = r4; //record the new latency
   M[$init_latency_state] = Null;   //reinitialise the algorithm which uses it
target_latency_not_updated:   
#endif
   M[enabled] = r1;
